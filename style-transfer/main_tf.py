...
CONTENT_IMG = getPath('./asset/content.jpg')
STYLE_IMG = getPath('./asset/style5.jpg')
OUTPUT_DIR = getPath('./asset/tf_model_result/')
...
BETA = 5
ALPHA = 100
VGG_MODEL = getPath('./imagenet-vgg-verydeep-19.mat')
